                ...
                <table class="table-auto w-full text-left whitespace-no-wrap">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="px-4 py-3">テストテストテストテストテストテスト</td>
                            <td class="px-4 py-3">2025-01-01 00:00:00</td>
                            <td class="px-4 py-3 text-lg text-gray-900">
                                <button {{-- onclick="location.href='{{ route('admin.categories.show', ['categoryId' => $category->id]) }}'" --}}
