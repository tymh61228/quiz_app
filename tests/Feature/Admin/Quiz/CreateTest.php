...
class CreateTest extends TestCase
{
    ...
    {
        $response = $this->get(route('admin.categories.quizzes.create', ['categoryId' => $this->category->id]));
     ...
     */
    #[Test]
    public function クイズ新規登録画面が表示されること(): void
    {
        $this->get(route('admin.categories.quizzes.create', ['categoryId' => $this->category->id]))
